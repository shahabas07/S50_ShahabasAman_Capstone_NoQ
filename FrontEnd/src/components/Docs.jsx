...
function Docs() {
  return (
    <div className='flex'>
      <div className='bg-violet-900 px-8  py-6 w-1/3  text-white'>
        <div>
        <a href="/" className="logo fixed  ">
          NoQ
        </a> </div>
        <div className='mt-4 mb-1 p-2 text-xl hover:bg-slate-500 rounded fixed top-12 pr-24'>
        <a href="#about"> 
          About
        </a></div>
        <div className='mb-1 p-2 text-xl hover:bg-slate-500 rounded fixed top-28 pr-16'>
        <a href="#contacts">
          Contacts
        </a></div><div className='mb-1 p-2 text-xl hover:bg-slate-500 rounded fixed top-40 pr-16'>
        <a href="#feedback"> 
          Feedback
        </a></div>
      </div>
      <div className='pt-20 px-9 pr-56 pb-36'>
        ...
        <p>Company Name: [Your Company Name]<br />
        ...
        <p className='w-2/3'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Praesentium odio odit quas facilis voluptas, laborum beatae itaque commodi magnam, quidem ducimus rem eligendi recusandae quaerat alias necessitatibus maxime corrupti natus!</p>
      </div>
    </div>
  );
}
